...
class BaseModule {
    ...
    initRoutes(){
        ...
        this.app.get(_prefix, (req, res, next) => {
            console.log("<------------> Module: "+this.opt.name+", Controller: Default, Acctio: selectAll");
            this.controller.selectAll(req, res, next);
        });
        this.app.post(_prefix, (req, res, next) => {
            console.log("<------------> Module: "+this.opt.name+", Controller: Default, Acction: insert");
            this.controller.insert(req, res, next);
        });
        this.app.get(_prefix+"/:id", (req, res, next) => {
            console.log("<------------> Module: "+this.opt.name+", Controller: Default, Acction: select");
            this.controller.select(req, res, next);
        });
        this.app.put(_prefix+"/:id", (req, res, next) => {
            console.log("<------------> Module: "+this.opt.name+", Controller: Default, Acction: update");
        ...
        this.app.delete(_prefix+"/:id", (req, res, next) => {
            console.log("<------------> Module: "+this.opt.name+", Controller: Default, Acction: delete");
